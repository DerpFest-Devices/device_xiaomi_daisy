...
public class YellowFlashPreference extends CustomSeekBarPreference {
    ...
    private static final String FILE_LEVEL = "/sys/devices/platform/soc/soc:qcom,camera-flash/leds/torch-light1/max_brightness";
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(DeviceSettings.KEY_FLASH, String.valueOf(mDefVal));
    ...
    private void saveValue(String newValue) {
        ...
        editor.putString(DeviceSettings.KEY_FLASH, newValue);
        editor.apply();
    }
