...
#
# DESCRIPTION
#    The script generates and updates proprietary-files.txt or proprietary-files-qc.txt sha1sum from a
#    vendor commit id.
#
# EXAMPLES
#    ./generate_sha1_from_commit_common.sh 1a2b3c4d
#
# AUTHOR
#    Chenyang Zhong
#
...
DIR_PREFIX="msm8953-common/proprietary/"
...
do
    ...
    # iterate through lines in proprietary-files-qc.txt until the first
    # non-comment match
    for line in $(grep "$file_stripped" "${MY_DIR}/proprietary-files-qc.txt")
    do
        ...
        sed -i "$sedstr" "${MY_DIR}/proprietary-files-qc.txt"
